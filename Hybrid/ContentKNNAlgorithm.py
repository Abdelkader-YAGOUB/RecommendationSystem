...
#pb = ProgressBar(total=8500,prefix='', suffix='', decimals=3, length=50, fill='|', zfill='-')
...
class ContentKNNAlgorithm(AlgoBase):
    ...
    def fit(self, trainset):
        ...
        print(BeginGREEN +"Computing content-based similarity matrix..." + EndGREEN)
        ...
        for thisRating in range(self.trainset.n_items):
            #if (thisRating % 100 == 0):
                ### print similarity matrix - 100 of 8211 
                #print(thisRating, " of ", self.trainset.n_items)
            #pb.print_progress_bar(thisRating)
